...
public:
  ...
  // if not.
  static bool hermesBytecodeSanityCheck(const uint8_t *data, size_t len,
  ...
  getBytecodeEpilogue(const uint8_t *data, size_t len);
  ...
  void loadSegment(std::unique_ptr<const jsi::Buffer> buffer,
  ...
  /// used for debugging.
  void debugJavaScript(const std::string &src, const std::string &sourceURL,
...
HERMES_EXPORT std::unique_ptr<HermesRuntime>
makeHermesRuntime(const ::hermes::vm::RuntimeConfig &runtimeConfig =
                      ::hermes::vm::RuntimeConfig());
HERMES_EXPORT std::unique_ptr<jsi::ThreadSafeRuntime>
makeThreadSafeHermesRuntime(const ::hermes::vm::RuntimeConfig &runtimeConfig =
                                ::hermes::vm::RuntimeConfig());
} // namespace hermes
} // namespace facebook
