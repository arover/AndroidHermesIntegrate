...
public:
  ...
  class TraceValue {
  public:
    bool isUndefined() const { return tag_ == Tag::Undefined; }

    bool isNull() const { return tag_ == Tag::Null; }

    bool isNumber() const { return tag_ == Tag::Number; }

    bool isBool() const { return tag_ == Tag::Bool; }

    bool isObject() const { return tag_ == Tag::Object; }

    bool isBigInt() const { return tag_ == Tag::BigInt; }

    bool isString() const { return tag_ == Tag::String; }

    bool isPropNameID() const { return tag_ == Tag::PropNameID; }
    ...
    static TraceValue encodeNullValue() { return TraceValue(Tag::Null); }

    static TraceValue encodeBoolValue(bool value) { return TraceValue(value); }
  ...
  private:
    ...
    TraceValue(bool b) : tag_(Tag::Bool) { val_.b = b; }
    TraceValue(double n) : tag_(Tag::Number) { val_.n = n; }
    TraceValue(Tag tag, uint64_t uid) : tag_(tag) { val_.uid = uid; }
...
#undef RECORD
  ...
  struct Record {
    ...
    // decoding onto objs.
    static void pushIfTrackedValue(const TraceValue &val,
    ...
    /// executed.
    virtual std::vector<ObjectID> defs() const { return {}; }
    ...
    virtual std::vector<ObjectID> uses() const { return {}; }
  ...
  explicit SynthTrace(const ::hermes::vm::RuntimeConfig &conf,
  ...
  std::optional<ObjectID> globalObjID() const { return globalObjID_; }
  ...
  constexpr static uint32_t synthVersion() { return 4; }
...
private:
  llvh::raw_ostream &os() const { return (*traceStream_); }
...
public:
  ...
  struct MarkerRecord : public Record {
    ...
    RecordType getType() const override { return type; }
  ...
  struct BeginExecJSRecord final : public Record {
    ...
    explicit BeginExecJSRecord(TimeSinceStart time, std::string sourceURL,
                               ::hermes::SHA1 sourceHash, bool sourceIsBytecode)
        : Record(time), sourceURL_(std::move(sourceURL)),
    ...
    const ::hermes::SHA1 &sourceHash() const { return sourceHash_; }
  ...
  struct CreateObjectRecord : public Record {
    ...
    std::vector<ObjectID> defs() const override { return {objID_}; }

    std::vector<ObjectID> uses() const override { return {}; }
  };
  ...
  struct CreateBigIntRecord : public Record {
    ...
    CreateBigIntRecord(TimeSinceStart time, ObjectID objID, Method m,
                       uint64_t bits)
  ...
  struct BigIntToStringRecord : public Record {
    ...
    BigIntToStringRecord(TimeSinceStart time, ObjectID strID, ObjectID bigintID,
                         int radix)
    ...
    std::vector<ObjectID> defs() const override { return {strID_}; }

    std::vector<ObjectID> uses() const override { return {bigintID_}; }
  };
  ...
  struct CreateStringRecord : public Record {
    ...
    // General UTF-8.
    CreateStringRecord(TimeSinceStart time, ObjectID objID,
                       const uint8_t *chars, size_t length)
        : Record(time), objID_(objID),
          chars_(reinterpret_cast<const char *>(chars), length), ascii_(false) {
    }
    // Ascii.
    CreateStringRecord(TimeSinceStart time, ObjectID objID, const char *chars,
                       size_t length)
  ...
  struct CreatePropNameIDRecord : public Record {
    ...
    // General UTF-8.
    CreatePropNameIDRecord(TimeSinceStart time, ObjectID propNameID,
                           const uint8_t *chars, size_t length)
        : Record(time), propNameID_(propNameID),
          chars_(reinterpret_cast<const char *>(chars), length),
          valueType_(UTF8) {}
    // Ascii.
    CreatePropNameIDRecord(TimeSinceStart time, ObjectID propNameID,
                           const char *chars, size_t length)
        : Record(time), propNameID_(propNameID), chars_(chars, length),
          valueType_(ASCII) {}
    ...
    std::vector<ObjectID> defs() const override { return {propNameID_}; }
  ...
  struct CreateHostFunctionRecord final : public CreateObjectRecord {
    ...
    CreateHostFunctionRecord(TimeSinceStart time, ObjectID objID,
                             ObjectID propNameID,
#ifdef HERMESVM_API_TRACE_DEBUG
                             std::string functionName,
#endif
                             unsigned paramCount)
        : CreateObjectRecord(time, objID), propNameID_(propNameID),
#ifdef HERMESVM_API_TRACE_DEBUG
    ...
    std::vector<ObjectID> uses() const override { return {propNameID_}; }
  };
  ...
  struct QueueMicrotaskRecord : public Record {
    ...
    std::vector<ObjectID> uses() const override { return {callbackID_}; }
  };
  ...
  struct GetPropertyRecord : public Record {
    ...
    GetPropertyRecord(TimeSinceStart time, ObjectID objID, TraceValue propID
#ifdef HERMESVM_API_TRACE_DEBUG
                      ,
  ...
  struct SetPropertyRecord : public Record {
    ...
    SetPropertyRecord(TimeSinceStart time, ObjectID objID, TraceValue propID,
#ifdef HERMESVM_API_TRACE_DEBUG
                      const std::string &propNameDbg,
#endif
                      TraceValue value)
  ...
  struct HasPropertyRecord final : public Record {
    ...
    HasPropertyRecord(TimeSinceStart time, ObjectID objID, TraceValue propID
#ifdef HERMESVM_API_TRACE_DEBUG
                      ,
                      const std::string &propNameDbg
#endif
  ...
  struct GetPropertyNamesRecord final : public Record {
    ...
    void toJSONInternal(::hermes::JSONEmitter &json) const override;
    RecordType getType() const override { return type; }
    std::vector<ObjectID> uses() const override { return {objID_}; }
  };
  ...
  struct CreateArrayRecord final : public Record {
    ...
    explicit CreateArrayRecord(TimeSinceStart time, ObjectID objID,
                               size_t length)
  ...
  struct ArrayWriteRecord final : public Record {
    ...
    explicit ArrayWriteRecord(TimeSinceStart time, ObjectID objID, size_t index,
                              TraceValue value)
  ...
  struct CallRecord : public Record {
    ...
    explicit CallRecord(TimeSinceStart time, ObjectID functionID,
                        TraceValue thisArg, const std::vector<TraceValue> &args)
        : Record(time), functionID_(functionID), thisArg_(thisArg),
          args_(args) {}
  ...
  struct GetOrSetPropertyNativeRecord : public Record {
    ...
    GetOrSetPropertyNativeRecord(TimeSinceStart time, ObjectID hostObjectID,
                                 ObjectID propNameID,
                                 const std::string &propName)
        : Record(time), hostObjectID_(hostObjectID), propNameID_(propNameID),
          propName_(propName) {}

    void toJSONInternal(::hermes::JSONEmitter &json) const override;
    std::vector<ObjectID> defs() const override { return {propNameID_}; }
    std::vector<ObjectID> uses() const override { return {hostObjectID_}; }
  ...
  struct SetPropertyNativeRecord final : public GetOrSetPropertyNativeRecord {
    ...
    SetPropertyNativeRecord(TimeSinceStart time, ObjectID hostObjectID,
                            ObjectID propNameID, const std::string &propName,
                            TraceValue value)
        : GetOrSetPropertyNativeRecord(time, hostObjectID, propNameID,
                                       propName),
          value_(value) {}
  ...
  struct GetNativePropertyNamesRecord : public Record {
    ...
    explicit GetNativePropertyNamesRecord(TimeSinceStart time,
  ...
  struct GetNativePropertyNamesReturnRecord final : public Record {
    ...
    explicit GetNativePropertyNamesReturnRecord(
        TimeSinceStart time, const std::vector<TraceValue> &propNameIDs)
  ...
  struct SetExternalMemoryPressureRecord final : public Record {
    ...
    explicit SetExternalMemoryPressureRecord(TimeSinceStart time,
  ...
  struct Utf8Record final : public Record {
    ...
    explicit Utf8Record(TimeSinceStart time, const TraceValue objID,
                        std::string retval)
