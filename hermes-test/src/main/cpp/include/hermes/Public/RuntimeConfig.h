...
#define RUNTIME_FIELDS(F)                                                      \
  ...
  F(constexpr, unsigned, NativeStackGap, 64 * 1024)                            \
                                                                               \
  /* Whether to allow runner_eval and Function ctor */                         \
  F(constexpr, bool, EnableEval, true)                                         \
                                                                               \
  /* Whether to verify the IR generated by runner_eval and Function ctor */    \
  F(constexpr, bool, VerifyEvalIR, false)                                      \
                                                                               \
  /* Whether to optimize the code inside runner_eval and Function ctor */      \
  F(constexpr, bool, OptimizedEval, false)                                     \
                                                                               \
  /* Whether to emit async break check instructions in runner_eval code */     \
  ...
  F(constexpr, CompilationMode, CompilationMode,                               \
  ...
  F(HERMES_NON_CONSTEXPR, std::shared_ptr<CrashManager>, CrashMgr,             \
    new NopCrashManager)                                                       \
                                                                               \
