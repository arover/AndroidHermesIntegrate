...
void setChromeLocation(
    T &chromeLoc, const facebook::hermes::debugger::SourceLocation &hermesLoc) {
...
ErrorResponse makeErrorResponse(int id, ErrorCode code,
...
makeCallFrames(const facebook::hermes::debugger::StackTrace &stackTrace);
...
makeSamplingHeapProfile(const std::string &value);
