...
public:
  ...
  TracingRuntime(std::unique_ptr<jsi::Runtime> runtime,
  ...
  void setPropertyValue(const jsi::Object &obj, const jsi::String &name,
                        const jsi::Value &value) override;
  void setPropertyValue(const jsi::Object &obj, const jsi::PropNameID &name,
                        const jsi::Value &value) override;
  ...
  jsi::Value call(const jsi::Function &func, const jsi::Value &jsThis,
                  const jsi::Value *args, size_t count) override;

  jsi::Value callAsConstructor(const jsi::Function &func,
                               const jsi::Value *args, size_t count) override;
  ...
  SynthTrace &trace() { return trace_; }

  const SynthTrace &trace() const { return trace_; }
...
private:
  ...
  std::vector<SynthTrace::TraceValue> argStringifyer(const jsi::Value *args,
                                                     size_t count,
                                                     bool assignNewUID = false);
...
public:
  ...
  TracingHermesRuntime(std::unique_ptr<HermesRuntime> runtime,
...
std::unique_ptr<TracingHermesRuntime>
makeTracingHermesRuntime(std::unique_ptr<HermesRuntime> hermesRuntime,
                         const ::hermes::vm::RuntimeConfig &runtimeConfig,
