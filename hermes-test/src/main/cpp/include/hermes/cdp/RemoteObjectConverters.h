...
RemoteObject makeRemoteObject(
    ...
    cdp::RemoteObjectsTable &objTable, const std::string &objectGroup,
    const cdp::ObjectSerializationOptions &serializationOptions);

RemoteObject makeRemoteObjectForError(facebook::jsi::Runtime &runtime,
                                      const facebook::jsi::Value &value,
                                      cdp::RemoteObjectsTable &objTable,
                                      const std::string &objectGroup);

ExceptionDetails makeExceptionDetails(jsi::Runtime &runtime,
...
ExceptionDetails
makeExceptionDetails(facebook::jsi::Runtime &runtime,
