...
struct ConsoleMessage {
  ...
  ConsoleMessage(double timestamp, ConsoleAPIType type,
                 std::vector<jsi::Value> args,
                 debugger::StackTrace stackTrace = {})
...
public:
  ...
  subscribe(std::function<void(const ConsoleMessage &)> handler) {
...
private:
  ...
  std::unordered_map<ConsoleMessageRegistration,
