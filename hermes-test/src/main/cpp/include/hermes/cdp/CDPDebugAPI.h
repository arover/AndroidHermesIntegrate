...
public:
  ...
  static std::unique_ptr<CDPDebugAPI>
  create(HermesRuntime &runtime,
         size_t maxCachedMessages = kMaxCachedConsoleMessages);
  ~CDPDebugAPI();

  /// Gets the runtime originally passed into this instance.
  HermesRuntime &runtime() { return runtime_; }

  /// Gets the AsyncDebuggerAPI associated with this instance.
  debugger::AsyncDebuggerAPI &asyncDebuggerAPI() { return *asyncDebuggerAPI_; }
