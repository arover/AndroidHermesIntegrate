...
template <typename T> inline Value toValue(Runtime &runtime, const T &other) {
...
template <typename T> inline T Runtime::make(Runtime::PointerValue *pv) {
  return T(pv);
}
...
inline const Runtime::PointerValue *
Runtime::getPointerValue(const jsi::Pointer &pointer) {
  return pointer.ptr_;
}

inline const Runtime::PointerValue *
Runtime::getPointerValue(const jsi::Value &value) {
...
template <typename T> inline bool Object::isHostObject(Runtime &runtime) const {
...
Object::getHostObject<HostObject>(Runtime &runtime) const {
...
inline Value
Function::callAsConstructor(Runtime &runtime,
                            std::initializer_list<Value> args) const {
