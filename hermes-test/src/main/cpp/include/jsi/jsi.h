...
public:
  ...
  virtual std::shared_ptr<const PreparedJavaScript>
...
protected:
  ...
  virtual ArrayBuffer
  createArrayBuffer(std::shared_ptr<MutableBuffer> buffer) = 0;
...
public:
  ...
  template <typename T = HostObject> bool isHostObject(Runtime &runtime) const;
...
public:
  ...
  template <typename T = void> Value(Runtime &, const char *) {
